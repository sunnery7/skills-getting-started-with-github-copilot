...
activities = {
    ...
    "Soccer Club": {
        "description": "Team practices and local matches; fundamentals and teamwork",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Track and Field": {
        "description": "Sprint, middle-distance, long-distance training and field events",
    ...
    "Drama Club": {
        "description": "Acting, play production, and stagecraft with semester performances",
    ...
    "Debate Team": {
        "description": "Competitive debate practice, public speaking, and reasoning skills",
        "schedule": "Mondays and Thursdays, 4:15 PM - 5:45 PM",
        "max_participants": 16,
    ...
    "Science Club": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["sophia.s@mergington.edu", "jack@mergington.edu"]
    }
}
